    ...
    <>
      ...
      <div className="w-full bg-terra pt-148 flex flex-col items-center relative max-[601px]:gap-20 max-[601px]:pt-20 pb-14">
        ...
        <Container>
          <div className="flex items-center max-[1281px]:grid max-[1281px]:grid-cols-1 max-[1281px]:gap-6">
            ...
            >
              <Image
                ...
                fill
                alt="Thumb Rimborso"
                className="object-cover transition-all duration-300 group-hover:blur-sm group-hover:brightness-75 max-[600px]:blur-sm max-[600px]:brightness-75"
              />
                ...
                <div className="flex flex-col items-center transition-all duration-300 group-hover:-translate-y-4 max-[600px]:-translate-y-4">
                  ...
                  {isValidMedia(rimborso.thumbInfo.logo) && (
                    <Image
                      ...
                      alt="Logo Rimborso"
                      className="max-w-51.75 h-auto translate-y-28 transition-all group-hover:translate-y-0 max-[600px]:translate-y-0 duration-300"
                    />
                  )}
                  ...
                  <svg
                    ...
                    className="opacity-0 group-hover:opacity-100 max-[600px]:opacity-100 transition-opacity duration-300"
                  >
                    <path
          ...
          <div className="flex items-center justify-between mt-35.75 max-[769px]:mt-20 relative max-[1281px]:grid max-[1281px]:grid-cols-2 max-[1281px]:gap-6 max-[769px]:gap-6 max-[600px]:grid-cols-1">
            <Link
              href={'/comunita'}
            ...
            <div className="h-96 w-176.25 absolute top-1/2 -translate-1/2 left-1/2 rounded-2xl p-0.5 bg-linear-to-tl from-bege via-terra via-45% to-[#6E2D39] max-[1281px]:static max-[1281px]:top-0 max-[1281px]:left-0 max-[1281px]:translate-0 max-[1281px]:col-span-2 max-[1281px]:mx-auto max-[1025px]:w-full max-[600px]:col-span-1">
              <div className="w-full h-full p-4 inset-0 bg-terra rounded-2xl text-center flex flex-col gap-5 items-center justify-center">
                <RichText
          ...
          <div className="flex mt-28 max-[769px]:mt-20 w-full justify-center max-[1281px]:grid max-[1281px]:grid-cols-1 max-[1281px]:gap-6">
            <div className="h-111.5 w-157.75 mt-8 rounded-2xl p-0.5 bg-linear-to-br from-bege via-terra via-45% to-[#6E2D39] relative max-[1281px]:mx-auto max-[1025px]:w-full">
              <div className="w-full h-full p-4 inset-0 bg-terra rounded-2xl pt-18.25 pl-25.75 flex flex-col gap-5 max-[769px]:pl-4 max-[769px]:pt-0 max-[769px]:items-center max-[769px]:justify-center max-[769px]:text-center">
                <RichText
            ...
            >
              <Image
                ...
                fill
                alt="Thumb Rimborso"
                className="object-cover transition-all duration-300 group-hover:blur-sm group-hover:brightness-75 max-[600px]:blur-sm max-[600px]:brightness-75 max-[1281px]:object-top"
              />
              {/* Overlay com conteúdo */}
              <div className="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/40 max-[600px]:bg-black/40 transition-all duration-300">
                <div className="flex flex-col items-center transition-all duration-300 group-hover:-translate-y-4 max-[600px]:-translate-y-4">
      ...
      <div className="w-full bg-terra pt-20 max-[1025px]:pb-20">
        <Container className="flex items-center justify-between max-[769px]:flex-col max-[769px]:items-start relative">
          <div className="w-full h-0.5 bg-linear-to-r from-bege to-[#151515] absolute left-0 top-[55%] max-[1025px]:hidden" />
          ...
          <div className="max-w-83.5 flex flex-col items-end text-end max-[769px]:text-start max-[769px]:items-start">
            <div className="flex flex-col space-y-2 items-end max-[769px]:items-start max-[769px]:mt-14 max-[600px]:flex-row max-[600px]:gap-10">
              {settings.linkAndroid && (
                <a href={settings.linkAndroid} target="_blank" rel="noopener noreferrer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={109}
                    height={32}
              ...
              {settings.linkIOS && (
                <a href={settings.linkIOS} target="_blank" rel="noopener noreferrer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={96}
                    height={32}
